...
const Contact = () => {
    ...
    const sendData = () => {
        ...
        let subject = "Contact Inquiry from Your Website";
        let body = `Name: ${name}%0D%0AEmail: ${email}%0D%0APhone: ${phone}%0D%0ACompany: ${company}%0D%0AMessage: ${message}`;
    
        // Create the email link
        let mailtoLink = `mailto:info@shamalimited.com?subject=${subject}&body=${body}`;
                    ...
                    <div className="col-md-6">
                        <div className="form-check">
                            ...
                            <label style={{ fontWeight: "lighter" }} className="form-check-label" htmlFor="flexCheckDefault">
                                I consent to receive future communications from Shama ltd.
                            </label>
                        </div>
                    </div>
                    <div className="col-md-6">
